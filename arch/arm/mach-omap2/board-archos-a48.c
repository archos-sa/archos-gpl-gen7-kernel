...
static struct archos_usb_config usb_config __initdata = {
	...
	.rev[0] = {
		.usb_id = UNUSED_GPIO,
		.enable_usb_musb = { .nb = 62,  .mux_cfg = H1_3430_GPIO62   }, 	//enable0
		.enable_usb_ehci = { .nb = 60, .mux_cfg = G3_3430_GPIO60 },	//enable1
	},
	.rev[1] = {
		.usb_id = UNUSED_GPIO,
		.enable_usb_musb = { .nb = 62,  .mux_cfg = H1_3430_GPIO62   }, 	//enable0
...
static struct archos_display_config display_config __initdata = {
	...
	.rev[0] = {
		...
		.lcd_pci = 	UNUSED_GPIO,
		.hdmi_dac = 	{ 57,	P8_3430_GPIO57 },
		.hdmi_it = 	{ 100,	AH17_3430_GPIO100 },
		.cpld_aux = 	{ 163,	H18_3430_GPIO163 },
		.bkl_pwm = 	{ .timer = 10, .mux_cfg = R8_3430_GPT10 },
		.spi = {
			.spi_clk  = { .nb = 138, .mux_cfg = AF3_3430_GPIO138 },
			.spi_data = { .nb = 139, .mux_cfg = AE3_3430_GPIO139  },
			.spi_cs   = { .nb = 156, .mux_cfg = Y21_3430_GPIO156  },
		},
	},
	.rev[1] = {
		.cpldreset = 	{ 136,	AE4_3430_GPIO136 },
...
static struct archos_charge_config charge_config __initdata = {
	...
	.rev[2] = { .nb = 159, .mux_cfg = U21_3430_GPIO159 },
	.rev[3] = { .nb = 159, .mux_cfg = U21_3430_GPIO159 },
};
...
static struct archos_vbus_config vbus0_config __initdata = {
	...
	.rev[2] = { .nb = 61, .mux_cfg = U3_3430_GPIO61 },
	.rev[3] = { .nb = 61, .mux_cfg = U3_3430_GPIO61 },
};
...
static struct archos_sata_config sata_config __initdata = {
	...
	.rev[0] = {
		...
		.sata_power = { .nb = 128, .mux_cfg = R27_3430_GPIO128 },
		.sata_ready = { .nb = 64, .mux_cfg = K8_3430_GPIO64},
	},
	.rev[1] = {
		.hdd_power = { .nb = 129, .mux_cfg = R25_3430_GPIO129 },
		.sata_power = { .nb = 128, .mux_cfg = R27_3430_GPIO128 },
...
{
	omap_register_i2c_bus(1, 100, board_i2c_bus1_info,
...
MACHINE_START(ARCHOS_A48, "Archos A48 board")
	.phys_io	= 0x48000000,
